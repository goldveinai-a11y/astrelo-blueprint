...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Decode your birth date. Unlock your financial potential and clear karmic blocks with a personalised 31-page Numerology Blueprint." },
