...
const MILESTONES = {
  ...
  4: { image: ms4, eyebrow: "Calculation Phase 1: Complete 🎉", title: "You've done the hard work.", body: "Your dedication is incredible. We have successfully isolated the exact core blocks holding back your Money, Love, and Inner Peace. The mathematical algorithm is now ready to compile your 31-page personal Numerology Blueprint. Let's secure your profile.", cta: "Proceed to My Results ➡️" },
} as const;
